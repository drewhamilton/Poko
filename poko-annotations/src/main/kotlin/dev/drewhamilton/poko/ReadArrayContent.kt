 ...
 * [toString].
 *
 * Like data classes, [Poko] classes do not read array content by default. Using array properties in data models is not
 * generally recommended, because they are mutable. Mutating an array marked with this annotation will cause the parent
 * Poko class to produce different `equals` and `hashCode` results at different times. This annotation should only be
 * used by consumers for whom performant code is more important than safe code.
 *
